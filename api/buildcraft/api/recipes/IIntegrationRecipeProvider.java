...
public interface IIntegrationRecipeProvider {
     ...
     * @return */
    @Nullable
    IntegrationRecipe getRecipeFor(@Nonnull ItemStack target, @Nonnull DefaultedList<ItemStack> toIntegrate);

    /**
     * Returns recipe by it's name
     */
    IntegrationRecipe getRecipe(@Nonnull Identifier name);
}
